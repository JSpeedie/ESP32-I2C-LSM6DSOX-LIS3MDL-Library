...
struct i2c_lis3mdl esp_i2c_lis3mdl_begin(i2c_master_dev_handle_t *dev_handle) {
    ...
    struct i2c_lis3mdl ret;

    /* 4b. Set the sensitivity multiplier for the LIS3MDL (datasheet page 21) */
    switch (ctrl_reg2_content.fs) {
        case LIS3MDL_FS_4GAUSS:
            ret.sensitivity = LIS3MDL_SENSITIVITY_FS_4GAUSS;
            break;
        case LIS3MDL_FS_8GAUSS:
            ret.sensitivity = LIS3MDL_SENSITIVITY_FS_8GAUSS;
            break;
        case LIS3MDL_FS_12GAUSS:
            ret.sensitivity = LIS3MDL_SENSITIVITY_FS_12GAUSS;
            break;
        case LIS3MDL_FS_16GAUSS:
            ret.sensitivity = LIS3MDL_SENSITIVITY_FS_16GAUSS;
            break;
        default:
            ret.sensitivity = LIS3MDL_SENSITIVITY_FS_4GAUSS;
    }
...
void esp_i2c_lis3mdl_get_data(struct i2c_lis3mdl *i2c_lis3mdl, \
    i2c_master_dev_handle_t *dev_handle, float *outxyz) {
