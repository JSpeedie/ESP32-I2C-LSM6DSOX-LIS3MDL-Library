...
struct i2c_lsm6dsox esp_i2c_lsm6dsox_begin(i2c_master_dev_handle_t *dev_handle) {
    ...
    struct i2c_lsm6dsox ret;

    /* 5b. Set the accelerometer sensitivity multiplier for the LSM6DSOX
     * (datasheet page 56) */
    switch (ctrl1_xl_content.fs_xl) {
        case LSM6DSOX_FS_XL_00:
            ret.accelerometer_sensitivity = LSM6DSOX_ACC_SENSITIVITY_FS_2G;
            break;
        case LSM6DSOX_FS_XL_01:
            ret.accelerometer_sensitivity = (ctrl8_xl_content.xl_fs_mode == 0) ? LSM6DSOX_ACC_SENSITIVITY_FS_16G : LSM6DSOX_ACC_SENSITIVITY_FS_2G;
            break;
        case LSM6DSOX_FS_XL_10:
            ret.accelerometer_sensitivity = LSM6DSOX_ACC_SENSITIVITY_FS_4G;
            break;
        case LSM6DSOX_FS_XL_11:
            ret.accelerometer_sensitivity = LSM6DSOX_ACC_SENSITIVITY_FS_8G;
            break;
        default:
            ret.accelerometer_sensitivity = LSM6DSOX_ACC_SENSITIVITY_FS_2G;
    }
    ...
    switch (ctrl2_g_content.fs_125) {
        case 1:
            ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_125DPS;
            break;
        case 0:
            switch (ctrl2_g_content.fs_g) {
                case LSM6DSOX_FS_G_00:
                    ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_250DPS;
                    break;
                case LSM6DSOX_FS_G_01:
                    ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_500DPS;
                    break;
                case LSM6DSOX_FS_G_10:
                    ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_1000DPS;
                    break;
                case LSM6DSOX_FS_G_11:
                    ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_2000DPS;
                    break;
                default:
                    ret.gyroscope_sensitivity = LSM6DSOX_GYRO_SENSITIVITY_FS_250DPS;
            }
...
void esp_i2c_lsm6dsox_get_gyro_data(struct i2c_lsm6dsox *i2c_lsm6dsox, \
    i2c_master_dev_handle_t *dev_handle, float *outxyz_g) {
...
void esp_i2c_lsm6dsox_get_accel_data(struct i2c_lsm6dsox *i2c_lsm6dsox, \
    i2c_master_dev_handle_t *dev_handle, float *outxyz_a) {
